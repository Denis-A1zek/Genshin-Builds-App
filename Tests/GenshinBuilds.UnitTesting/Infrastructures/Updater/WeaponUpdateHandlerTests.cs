...
public class WeaponUpdateHandlerTests
{
    ...
    public void Setup()
    {
        ...
        _weaponParser = new Mock<IParser<IEnumerable<Weapon>>>();
        _weaponRepository = new Mock<IRepository<Weapon>>();
        _weaponUpdateHandler = new WeaponUpdateHandler(_unitOfWork.Object, _weaponParser.Object);
    }
